...
if __name__ == '__main__':
    ...
    if MODE == 'train':
            ...
            for index in range(number_of_batches):
                ...
                if index % 10 == 0:
                    ...
                    for i, generated_volume in enumerate(generated_volumes[:5]):
                        ...
                        voxels[voxels < 0.5] = 0.
                        voxels[voxels >= 0.5] = 1.
                        saveFromVoxels(voxels, "img_{}_{}_{}".format(epoch, index, i))
        ...
        Save models
        """
        generator.save_weights(os.path.join( "generator_weights.h5"))
        discriminator.save_weights(os.path.join( "discriminator_weights.h5"))
    ...
    if MODE == 'predict':
        ...
        # Load model weights
        generator.load_weights(os.path.join( "generator_weights.h5"), True)
        discriminator.load_weights(os.path.join( "discriminator_weights.h5"), True)
